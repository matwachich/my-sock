...
'type mySrvOnReceivingProc as sub (mySrv as mySrv_t ptr, peer_id as integer, count as uinteger, total as uinteger)
...
'type myClnOnReceivingProc as sub (myCln as myCln_t ptr, count as uinteger, total as uinteger)
...
declare function	MySrv_GetAddrStrIp		(mySrv as mySrv_t ptr, port as ushort ptr) as string
declare function	MySrv_GetAddrStrIpPort	(mySrv as mySrv_t ptr) as string
...
declare function 	MySrv_PeersGetAll	(mySrv as mySrv_t ptr, peer_ids as integer ptr, peers_ids_size as integer) as integer
...
declare function	MySrv_PeerGetAddrStrIp		(mySrv as mySrv_t ptr, peer_id as integer, port as ushort ptr) as string
declare function	MySrv_PeerGetAddrStrIpPort	(mySrv as mySrv_t ptr, peer_id as integer) as string
...
declare function 	MyCln_GetHostStrIp		(myCln as myCln_t ptr, port as ushort ptr) as string
declare function 	MyCln_GetHostStrIpPort	(myCln as myCln_t ptr) as string
declare sub 		MyCln_GetSrvIp			(myCln as myCln_t ptr, ip as zstring, ip_len as uinteger)
declare function 	MyCln_GetSrvIpStrIp		(myCln as myCln_t ptr) as string
