...
'/ @brief Convert an internat name to IP address
 ...
 ' @return 1 on succes, 0 otherwise
 '/
function MySock_Host2ip (host as zstring, protocol as protocol_e, ip as zstring, ip_len as MYSIZE) as integer MYSOCK_EXPORT
...
'/ @brief Get the host name of this computer
 ...
 '/
sub MySock_MyHost (host as zstring, host_len as MYSIZE) MYSOCK_EXPORT
...
'/ @brief Get the local address of a connected/bound Socket ID (C-Style)
 ...
 ' @return 1 on succes, 0 otherwise
 '/
function MySock_SocketGetAddr (sock as MYSOCK, ip as zstring, ip_len as MYSIZE, port as ushort ptr) as integer MYSOCK_EXPORT
...
'/ @brief Get the remote address of a connected Socket ID (C-Style)
 ...
 ' @return 1 on succes, 0 otherwise
 '/
function MySock_SocketGetPeerAddr (sock as MYSOCK, ip as zstring, ip_len as MYSIZE, port as ushort ptr) as integer MYSOCK_EXPORT
    dim as sockaddr_storage addr
    dim as integer addr_len = sizeof(addr)
